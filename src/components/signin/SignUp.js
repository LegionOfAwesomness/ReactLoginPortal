...
//         <input type="text" name="lname" value={this.state.fields.mname} onChange={this.handleChange} />
...
<div id="main-registration-container" style={{background: 'white'}}>
<form className="ui form" method="post"  name="userRegistrationForm"  onSubmit= {this.submituserRegistrationForm}>

  {/* User Information with name dob and adress*/}

  <h2 class="ui dividing header" style={{color: 'red !important'}}>User Information</h2>
  <div class="field">
    <label>Name</label>

    <div class="field">
    <div class="three wide field">
      <input type="text" name="prefix" value={this.state.fields.prefix} onChange={this.handleChange} placeholder="Prefix"/>
      <div className="errorMsg">{this.state.errors.prefix}</div>
    </div>
  </div>
    <div class="two fields">
      <div class="field">
        <input type="text"  name="fname" value={this.state.fields.fname} onChange={this.handleChange} placeholder="First Name"/>
        <div className="errorMsg">{this.state.errors.fname}</div>
      </div>
      <div class="field">
        <input type="text"  name="lname" value={this.state.fields.lname} onChange={this.handleChange} placeholder="Last Name"/>
    ...
    <div class="two fields">
      <div class="field">
        <input type="text"  name="mname" value={this.state.fields.mname} onChange={this.handleChange} placeholder="Middle Name"/>
        <div className="errorMsg">{this.state.errors.mname}</div>
      </div>
      <div class="field">
        <input type="text"  name="suffix" value={this.state.fields.suffix} onChange={this.handleChange} placeholder="Suffix"/>
    ...
    <div class="three fields">
      <div class="field">
        <input type="text"  name="fname" value={this.state.fields.fname} onChange={this.handleChange} placeholder="Month"/>
      </div>
      <div class="field">
        <input type="text"  name="lname" value={this.state.fields.lname} onChange={this.handleChange} placeholder="Date"/>
      </div>
      <div class="field">
        <input type="text"  name="lname" value={this.state.fields.lname} onChange={this.handleChange} placeholder="Year"/>
      </div>
    ...
    <div class="two fields">
      <div class="field">
        <input type="text"  name="homephone" name="mobileno" value={this.state.fields.homephone} onChange={this.handleChange} placeholder="Home Phone"/>
        <div className="errorMsg">{this.state.errors.homephone}</div>
      </div>
      <div class="field">
        <input type="text"  name="mobileno" name="mobileno" value={this.state.fields.mobileno} onChange={this.handleChange}  placeholder="Cell Phone"/>
        <div className="errorMsg">{this.state.errors.mobileno}</div>
      </div>
    </div>
    ...
    <div class="two fields">
      <div class="field">
        <label>Zipcode</label>
        <input type="text" name="shipping[address-2]" placeholder="Zipcode"/>
      </div>
      <div class="field">
        <label>State</label>
...
{/* account information with id pwd */}
  ...
  <div class="eight wide field">
    <input type="text" name="emailid" value={this.state.fields.emailid} onChange={this.handleChange}  placeholder="Email Address"/>
    <div className="errorMsg">{this.state.errors.emailid}</div>
  </div>
</div>
 ...
 <div class="two fields">
  <div class="field">
    <input type="password" name="password" value={this.state.fields.password} onChange={this.handleChange} placeholder="Enter a Password"/>
    <div className="errorMsg">{this.state.errors.password}</div>
  </div>
  <div class="field">
    <input type="password" name="password" value={this.state.fields.password} onChange={this.handleChange} placeholder="Confirm Password"/>
    <div className="errorMsg">{this.state.errors.password}</div>
  </div>
</div>
...
{/* <h4 class="ui dividing header">Billing Information</h4>
  ...
  <div>
    ...
    <input type="submit" className="ui download primary button"  value="Register"/></div>
</form>
</div>
